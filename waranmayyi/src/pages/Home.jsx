...
function Home() {
  return (
    <div>
      <section className='relative min-h-screen overflow-hidden bg-linear-to-br from-slate-900 via-green-900 to-emerald-900'>
        ...
        <div className='relative z-10 mx-auto flex min-h-screen items-center px-6 py-14 sm:px-10 lg:px-16'>
          <div className='mx-auto w-full max-w-4xl text-center text-white'>
            ...
            <div className='mt-10 flex flex-wrap justify-center gap-4'>
              <button className='inline-flex items-center justify-center rounded-full bg-linear-to-r from-lime-500 to-green-500 px-8 py-3 text-base font-semibold text-white transition hover:from-lime-600 hover:to-green-600 hover:shadow-lg hover:shadow-lime-500/40'>
                Explore Products
              </button>
              <button className='inline-flex items-center justify-center rounded-full border border-emerald-400 bg-linear-to-r from-emerald-500 to-teal-500 px-8 py-3 text-base font-semibold text-white transition hover:from-emerald-600 hover:to-teal-600 hover:shadow-lg hover:shadow-emerald-500/40'>
                Join Our Network
              </button>
            </div>

            <div className='mt-12 grid gap-4 sm:grid-cols-3'>
              <div className='rounded-3xl border border-emerald-400/30 bg-linear-to-br from-emerald-500/10 to-emerald-600/5 px-5 py-4 backdrop-blur-sm transition hover:border-emerald-400/60 hover:bg-linear-to-br hover:from-emerald-500/20 hover:to-emerald-600/10'>
              ...
              <div className='rounded-3xl border border-lime-400/30 bg-linear-to-br from-lime-500/10 to-green-500/5 px-5 py-4 backdrop-blur-sm transition hover:border-lime-400/60 hover:bg-linear-to-br hover:from-lime-500/20 hover:to-green-500/10'>
              ...
              <div className='rounded-3xl border border-teal-400/30 bg-linear-to-br from-teal-500/10 to-cyan-500/5 px-5 py-4 backdrop-blur-sm transition hover:border-teal-400/60 hover:bg-linear-to-br hover:from-teal-500/20 hover:to-cyan-500/10'>
      ...
      <section className="py-16 bg-linear-to-br from-gray-50 to-green-50">
        <div className="mx-auto max-w-7xl px-6">
          <div className="text-center">
            <h2 className="text-3xl font-bold text-gray-900 sm:text-4xl lg:text-5xl">
              Featured Products
          ...
          <div className="mt-12 text-center">
            <button className="rounded-full bg-linear-to-r from-lime-500 to-green-500 px-8 py-3 text-base font-semibold text-white transition hover:from-lime-600 hover:to-green-600 hover:shadow-lg hover:shadow-lime-500/40">
              View All Products
            </button>
          </div>
        </div>
