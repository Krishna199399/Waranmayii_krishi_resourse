  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden bg-linear-to-br from-slate-50 via-emerald-50 to-lime-50 py-20 text-slate-900 sm:py-24">
        <div className="pointer-events-none absolute left-0 top-12 h-64 w-64 rounded-full bg-emerald-200/50 blur-3xl" />
        <div className="pointer-events-none absolute right-0 bottom-0 h-72 w-72 rounded-full bg-lime-200/50 blur-3xl" />
        ...
        <div className="relative mx-auto max-w-7xl px-6 sm:px-10 lg:px-16">
          ...
          <div className="mt-14 grid gap-14 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
            <div className="relative">
              <div className="pointer-events-none absolute inset-0 translate-x-5 translate-y-5 rounded-[2.75rem] border border-emerald-200/80 bg-white/30" />
              <div className="pointer-events-none absolute -left-8 top-16 h-40 w-40 rounded-full bg-emerald-300/40 blur-3xl" />

              <div className="relative overflow-hidden rounded-[2.75rem] border border-white/70 bg-white/60 p-4 shadow-[0_35px_110px_-60px_rgba(16,185,129,0.5)] backdrop-blur-xl">
                <div className="relative overflow-hidden rounded-[2.2rem]">
                  <img
                    src={heroBg}
                    alt="Sustainable nature-driven solutions"
                    className="h-[500px] w-full object-cover object-center"
                  />
                  <div className="absolute inset-0 bg-linear-to-t from-slate-950/74 via-slate-950/15 to-transparent" />
                </div>
              </div>
            </div>

            <div className="relative">
              <div className="pointer-events-none absolute -top-8 right-0 text-[7rem] font-black tracking-[-0.08em] text-emerald-100/70 sm:text-[9rem]">
                WHO
              </div>

              <div className="relative">
                <div className="inline-flex items-center gap-2 rounded-full bg-emerald-100/80 px-4 py-2 text-sm font-semibold uppercase tracking-[0.22em] text-emerald-800">
                  Purpose-driven
                </div>

                <div className="mt-8 space-y-8">
                  <div className="flex gap-5 border-b border-emerald-200/80 pb-7">
                    <span className="pt-1 text-xs font-black tracking-[0.28em] text-emerald-600">
                      01
                    </span>
                    <p className="max-w-2xl text-lg leading-8 text-slate-700 sm:text-xl">
                      Waranamayii is a purpose-driven organization focused on delivering
                      eco-friendly and bio-based products across multiple industries.
                    </p>
                  </div>

                  <div className="flex gap-5 border-b border-lime-200/80 pb-7">
                    <span className="pt-1 text-xs font-black tracking-[0.28em] text-lime-700">
                      02
                    </span>
                    <p className="max-w-2xl text-lg leading-8 text-slate-700 sm:text-xl">
                      Our goal is to promote healthier living and sustainable practices through
                      innovative and natural solutions.
                    </p>
                  </div>

                  <div className="flex gap-5">
                    <span className="pt-1 text-xs font-black tracking-[0.28em] text-teal-700">
                      03
                    </span>
                    <p className="max-w-2xl text-lg leading-8 text-slate-700 sm:text-xl">
                      We work across agriculture, wellness, personal care, and daily-use
                      products, helping individuals and communities move towards a better
                      lifestyle.
                    </p>
                  </div>
                </div>
